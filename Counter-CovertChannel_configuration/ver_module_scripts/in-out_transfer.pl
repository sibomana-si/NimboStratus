...
# in the "encrypted" directory, which interfaces with the ENC_MODULE 
# container. If a similar copy exists, it means that the file should 
...
# specified time constraint. Refer to the out-in_transfer.pl script to see
# how this works.)
# 
